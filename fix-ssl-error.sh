...
# AS of v14.1.0 of the java instance, the existing cacerts is passwordless (and cant be added too).  So we will replace it.
mv $JAVA_HOME/jre/lib/security/cacerts $JAVA_HOME/jre/lib/security/cacerts.backup
